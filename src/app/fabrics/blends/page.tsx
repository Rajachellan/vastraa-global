...
export const metadata: Metadata = {
  title: "Blended Fabrics Wholesale | Vastraa Global",
  description: "Buy premium blended fabrics online. Export-quality textiles, custom printing, and bulk orders for fashion brands.",
  alternates: {
    canonical: "https://vastraaglobal.com/fabrics/blends",
  },
};
  ...
  return (
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden pt-32 pb-16">
        <Image src="/images/fabric-blends.png" alt="Blends" fill priority sizes="100vw" className="object-cover" />
        <div className="absolute inset-0 bg-accent/40" />
        <div className="container mx-auto px-6 relative z-10 text-white">
          <div className="max-w-2xl animate-fade-in-up">
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-serif mb-6 leading-tight">
              Blended <span className="text-secondary">Fabrics</span>
            </h1>
      ...
      <section className="py-24 container mx-auto flex flex-col gap-10 px-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed">
            Discover premium blended fabrics crafted for modern fashion brands and apparel manufacturers. Vastraa Global delivers export-quality textiles with custom printing and bulk production support.
          </p>
      ...
      {/* FAQs */}
      <FabricFaqs faqs={[
        { question: `What are blended fabrics used for?`, answer: `test` },
        { question: `Do you offer bulk orders?`, answer: `test` },
        { question: `3ul`, answer: `75u6i7tlyi` }
