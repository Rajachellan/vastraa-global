  ...
  return (
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden pt-32 pb-16">
        <Image src="/images/fabric-cotton.png" alt="Modal" fill priority sizes="100vw" className="object-cover" />
      ...
      {items.length === 0 && (
        <section className="container mx-auto px-6 pb-20">
          <h2 className="text-3xl md:text-4xl font-semibold text-center text-black mb-10">
            Types of <span className="text-secondary italic">Modal</span>
          </h2>
