...
const trends = [
  { icon: Leaf, title: "Minimal luxury aesthetics  " },
  { icon: Flower2, title: "Botanical silk prints  " },
  { icon: Palette, title: "Contemporary fusion wear " },
  { icon: Shirt, title: "Soft pastel silk collections " },
...
const features = [
  {
    icon: Leaf,
    title: "Export-quality silk fabrics  ",
  },
  {
    icon: Globe2,
  ...
  {
    icon: Palette,
    title: "Advanced custom textile printing ",
  },
  {
    icon: Sparkles,
  ...
  {
    icon: Shirt,
    title: "Luxury-focused textile expertise ",
  },
  {
    icon: CheckCircle2,
  ...
  {
    icon: Truck,
    title: "Trend-driven fabric collections ",
  },
];
const silkTypes = [
  {
    ...
    image: "/images/fabrics/silk/silk (12).jpg",
  },
  {
    ...
    image: "/images/fabrics/silk/silk (4).jpg",
  },
  {
    ...
    image:"/images/fabrics/silk/silk (6).jpg",
  },
  {
    ...
    image: "/images/fabrics/silk/silk (7).jpg",
  },
  {
    ...
    image: "/images/fabrics/silk/silk (3).jpg",
  },
  {
...
export const metadata: Metadata = {
  title: "Wholesale Silk Fabrics for Fashion | Vastraa Global ",
  description: "Explore wholesale silk fabrics for luxury fashion, bridal wear, and designers. Premium quality, custom printing, bulk manufacturing, and exports. ",
  alternates: {
    canonical: "https://vastraaglobal.com/fabrics/wholesale-silk-fabrics",
  },
};
        ...
        <div className="container mx-auto px-6 relative z-10 text-white">
          <div className="max-w-3xl animate-fade-in-up">
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-serif mb-6 leading-tight">
              Wholesale <span className="text-secondary">Silk Fabrics</span>
            </h1>
      ...
      <section className="py-24 container mx-auto flex flex-col gap-10 px-6">
        ...
        Discover premium silk fabrics crafted for luxury fashion brands, designers, and apparel manufacturers worldwide. At Vastraa Global, we offer elegant silk fabric solutions designed for sophistication, fluid drape, and timeless beauty. From custom textile printing to bulk manufacturing, our silk fabrics are tailored for premium fashion collections and export-quality apparel production. 
         ...
         <section className="py-16 lg:py-14">
           ...
           <p className="text-gray-600 text-base md:text-lg leading-9">
                 Its premium appearance and lightweight comfort make silk fabrics ideal for couture fashion, occasion wear, designer collections, and luxury apparel. 
                        </p>
                        <p className="text-gray-600 text-base md:text-lg leading-9 mt-3">
                         At Vastraa Global, we provide high-quality silk fabrics suitable for custom printing, fashion manufacturing, and global textile production. 
                        </p>
                      ...
                      <div className="relative">
                        ...
                        <div className="overflow-hidden rounded-[30px]">
                          <Image
                            src="/images/fabrics/silk/silk (11).jpg"
         ...
         Silk fabrics are natural textiles made from fibers produced by silkworms. These fibers are woven into luxurious fabrics known for their softness, shine, and elegant drape. Silk fabrics are valued for: 
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-16">
              ...
              <div className="relative bg-white border border-gray-200 rounded-3xl p-8">
                ...
                <p className="mt-4 text-gray-600 leading-8">
                  Made from silkworm fibers, known for their smoothness and luster
                </p>
              </div>
          ...
          Because of their rich appearance and timeless elegance, silk fabrics are widely used in premium fashion and designer apparel collections. 
            </p>
          </div>
        </section>
        <Animationsection/>
  ...
  <div className="container-site">
    ...
    <div className="max-w-3xl mx-auto text-center">
      ...
      <p className="mt-8 text-lg text-gray-600 leading-9">
        Silk fabrics have evolved from traditional royal textiles into a modern
        luxury essential used across global fashion industries.
      </p>
    </div>
    ...
    <div className="relative mt-20">
      ...
      {[
        {
          year: "01",
          title: "Luxury Designer Collections",
          desc: "Silk remains the signature fabric for premium designer collections, offering unmatched elegance, sophistication, and timeless appeal.",
        },
        {
          year: "02",
          title: "Contemporary Couture Fashion",
          desc: "Modern couture designers use silk to create graceful silhouettes, luxurious draping, and exclusive fashion pieces.",
        },
        {
          year: "03",
          title: "Sustainable Premium Apparel",
          desc: "Responsibly sourced silk is increasingly used in sustainable luxury fashion, combining environmental awareness with premium quality.",
        },
        {
          year: "04",
          title: "Digital Textile Printing",
          desc: "Advanced digital printing technologies allow silk fabrics to showcase vibrant colors, intricate patterns, and customized luxury designs.",
        },
        {
          year: "05",
          title: "High-Fashion Resort & Fusion Wear",
          desc: "Silk has become a preferred fabric for modern resort wear, ethnic fashion, and contemporary fusion apparel across global markets.",
        },
      ].map((item, index) => (
        <div
          key={index}
    ...
    <div className="max-w-5xl mx-auto mt-12 text-center">
      <p className="text-lg text-gray-600 leading-9">
        Advanced textile processing and custom printing technologies now allow
        silk fabrics to blend heritage elegance with modern fashion innovation.
      </p>
    </div>
  </div>
</section>
                ...
                <div className="grid xl:grid-cols-2 gap-16 items-center">
                 ...
                 At Vastraa Global, we help fashion brands create premium apparel collections through high-quality linen fabric manufacturing and custom textile printing solutions. 
                    ...
                    <p className="mt-6 text-slate-400 leading-8">
                     We collaborate with fashion brands, designers, and apparel manufacturers to deliver silk fabrics tailored for luxury fashion and modern creative needs. 
                    </p>
              ...
              <div className="container-site">
                ...
                <div className="grid xl:grid-cols-2 gap-16 items-center">
                  ...
                  <div>
                   ...
                   Silk fabrics continue to evolve with changing luxury fashion trends and modern textile innovation. Trending silk fabric styles include: 
                    </p>
                  ...
                  <div className="relative">
                    ...
                    <Image
                      src="/images/fabrics/silk/silk (1).jpg"
                      alt=""
                      width={700}
                      height={700}
      ...
      <section className="container mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-[#D4AF37]/15 rounded-[30px] p-8 hover:-translate-y-1 hover:shadow-xl transition-all">
            ...
            <h3 className="text-xl font-semibold text-black mb-3">Premium Textile Manufacturing </h3>
            <p className="text-gray-600 text-sm leading-relaxed">Luxury-quality silk fabrics crafted with superior finishing and precision. </p>
          </div>
          <div className="bg-white border border-[#D4AF37]/15 rounded-[30px] p-8 hover:-translate-y-1 hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">Advanced printing solutions designed for premium silk fashion collections. </p>
          </div>
          <div className="bg-white border border-[#D4AF37]/15 rounded-[30px] p-8 hover:-translate-y-1 hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">Global-quality textile production suitable for international luxury markets. </p>
          </div>
          <div className="bg-white border border-[#D4AF37]/15 rounded-[30px] p-8 hover:-translate-y-1 hover:shadow-xl transition-all">
          ...
          <div className="bg-white border border-[#D4AF37]/15 rounded-[30px] p-8 hover:-translate-y-1 hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">Textile solutions tailored for designer labels and luxury fashion brands. </p>
          </div>
          <div className="bg-white border border-[#D4AF37]/15 rounded-[30px] p-8 hover:-translate-y-1 hover:shadow-xl transition-all">
            <div className="text-4xl font-bold text-[#D4AF37]/20 mb-4">06</div>
            <h3 className="text-xl font-semibold text-black mb-3">Reliable Bulk Manufacturing  </h3>
            <p className="text-gray-600 text-sm leading-relaxed">Scalable production support for growing apparel and textile businesses. </p>
          </div>
        </div>
      </section>
